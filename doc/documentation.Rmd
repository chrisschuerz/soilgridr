...
```{r}
shapefile_path <- system.file("extdata", "demo.shp", package = "solACE")

demo_shape <- readOGR(shapefile_path)
plot(demo_shape)
```
...
new_soil_project(project_name = "demo_soil", 
                 project_path = pro_path,
                 shape_file = demo_shape)
```
